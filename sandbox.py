...
CONTAINER_LABEL: Final[str] = "com.yantraos.sandbox.managed=true"
LEGACY_CONTAINER_LABEL: Final[str] = "yantra=sandbox"
...
class SandboxEngine:
    ...
    def _blocking_initialize(self) -> SandboxStatus:
        ...
        try:
            ...
            if not image_id.startswith("sha256:"):
                raise RuntimeError("sandbox image has no immutable image ID")
        except Exception as exc:
        ...
        log.info("Docker sandbox ready with pinned runtime %s (%s)", SANDBOX_IMAGE, image_id)
    ...
    def _blocking_execute(
        ...
        try:
            ...
            container = self._client.containers.create(
                ...
                stop_signal="SIGKILL",
                labels={
                    "com.yantraos.sandbox.managed": "true",
                    "com.yantraos.sandbox.script-hash": script_hash,
                },
    ...
    def _blocking_cleanup_stale_containers(self) -> int:
        ...
        try:
            ...
            for label in (CONTAINER_LABEL, LEGACY_CONTAINER_LABEL):
